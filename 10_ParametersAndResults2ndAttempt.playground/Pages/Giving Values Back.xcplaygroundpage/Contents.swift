...
makeFavorite(categoryOfThing: "Food", favorite: "Chicken")
...
makeFavorite(categoryOfThing: "Movie", favorite: "Spiderman")
makeFavorite(categoryOfThing: "Video Game", favorite: "NBA 2K")
...
let myFavoriteTeam = makeFavorite(categoryOfThing: "Team" , favorite: "Patriots")
let myFavoriteVideoGame = makeFavorite(categoryOfThing: "Video Game", favorite: "Resident Evil")

"Hello my name is Cristian. \(myFavoriteTeam) and \(myFavoriteVideoGame)" 
