...
let favoriteTeam = makeFavorite(categoryOfThing: "team", favorite: "Patriots")
let favoritePasta = makeFavorite(categoryOfThing: "pasta", favorite: "fettucini")
...
"Hello my name is Cristian. \(favoriteTeam)"
